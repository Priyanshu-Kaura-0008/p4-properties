  ...
  return (
    ...
    >
      ...
      <div className="p-5 sm:p-6">
        ...
        <h3 className="font-display text-xl font-bold text-ink sm:text-2xl">{property.title}</h3>
        <p className="mt-2 text-xl font-extrabold text-gold">{property.price}</p>
        <div className="mt-5 grid grid-cols-1 gap-3 border-y border-ink/10 py-4 text-sm font-semibold text-muted sm:grid-cols-3">
        ...
        <button className="mt-6 min-h-12 w-full rounded-xl border border-ink px-5 py-3 text-sm font-bold uppercase tracking-[0.16em] text-ink transition-colors group-hover:border-gold group-hover:bg-gold">
          View Details
        </button>
      </div>
    </motion.article>
  ...
  return (
    ...
    >
      ...
      <div className="p-5 sm:p-6">
        ...
        <h3 className="font-display text-xl font-bold leading-tight text-ink sm:text-2xl">{property.title}</h3>
        <p className="mt-2 text-xl font-extrabold text-gold">{property.price}</p>
        ...
        <div className="mt-6 grid gap-3 sm:grid-cols-2">
          <Link
            ...
            className="inline-flex min-h-12 items-center justify-center rounded-xl bg-night px-5 py-3 text-center text-sm font-extrabold uppercase tracking-[0.12em] text-white transition-colors hover:bg-gold hover:text-night"
          >
            View Details
          </Link>
          <a
