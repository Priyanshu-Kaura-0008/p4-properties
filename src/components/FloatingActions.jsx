  ...
  return (
    <div className="fixed bottom-5 right-5 z-[90] flex flex-col gap-3 sm:bottom-6 sm:right-6">
      <motion.a
        ...
        onClick={() => trackEvent('whatsapp_click', { source: 'floating_action' })}
        target="_blank"
        rel="noreferrer"
        aria-label={`Chat with ${COMPANY_INFO.companyName} on WhatsApp`}
      ...
      <motion.a
        ...
        onClick={() => trackEvent('phone_click', { source: 'floating_action' })}
        aria-label={`Call ${COMPANY_INFO.companyName} now`}
