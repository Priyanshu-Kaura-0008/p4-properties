import { FaBlog, FaCalendarCheck, FaCog, FaComments, FaHome, FaQuoteRight, FaSitemap, FaTachometerAlt } from 'react-icons/fa';

export const adminNavItems = [
  { label: 'Dashboard', to: '/admin', icon: FaTachometerAlt, end: true },
  { label: 'Properties', to: '/admin/properties', icon: FaHome },
  { label: 'Lead CRM', to: '/admin/crm', icon: FaSitemap },
